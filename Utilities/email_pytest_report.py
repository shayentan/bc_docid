...
from Configuration.emailconf import conf_email
...
class Email_Pytest_Report:
    ...
    def __init__(self):
        self.smtp_ssl_host = conf_email.smtp_ssl_host
        self.smtp_ssl_port = conf_email.smtp_ssl_port
        self.username = conf_email.username
        self.password = conf_email.app_password
        self.sender = conf_email.sender
        self.targets = conf_email.targets
    ...
    def send_test_report_email(self, html_body_flag=True, attachment_flag=False, report_file_path='default'):
        ...
        # 4. Add text formatted email body message along with an attachment file
            ...
            plain_text_body = MIMEText('''Hello,\n\tPlease check attachment to see test built report for bc_doc id.
        ...
        message['Subject'] = 'Script generated test report for bc_doc id api testing - Tesla'  # Update email subject here
...
if __name__ == '__main__':
    ...
    # Here log/pytest_report.html is a default file. To generate pytest_report.html file
    # use following command to the test e.g. py.test --html = log/pytest_report.html
    # email_obj.send_test_report_email(html_body_flag=True, attachment_flag=True, report_file_path='default')

    # Note: We commented below code to avoid sending multiple emails, you can try
    # the other cases one by one to know more about email_pytest_report util.
